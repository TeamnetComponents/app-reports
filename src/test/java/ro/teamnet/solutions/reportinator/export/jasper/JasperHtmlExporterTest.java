 ...
 */
public class JasperHtmlExporterTest {
    ...
    public void testExport() throws Exception {
        Exporter<JasperPrint> mockExporter = mock(JasperHtmlExporter.class, CALLS_REAL_METHODS);
    ...
    public void testShouldPassIfParametersAreNull() throws Exception{
        new JasperHtmlExporter().export(null, null);
    }
}
