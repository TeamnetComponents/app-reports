...
public final class JasperConstants extends Constants {
    ...
    public static final String JRXML_DEFAULT_PORTRAIT_TEMPLATE_PATH = "reports/template/default_template.jrxml"; // TODO Modify with correct path
    public static final String JRXML_DEFAULT_LANDSCAPE_TEMPLATE_PATH = "reports/template/default_template.jrxml"; // TODO Modify with correct path
